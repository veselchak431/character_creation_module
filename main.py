"""
An RPG game in which the user selects his class.

in the game with the help of the console,
 after which he pumps his character.
"""
...
def attack(char_name: str, char_class: str) -> str:
    """Calculate the hero's attack, depending on the class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Calculate the hero's defence, depending on the class."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Calculate the hero's special skill, depending on the class."""
    if char_class == 'warrior':
